        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
            ...
            <div className="flex items-center gap-3">
              <button className="p-3 bg-white hover:bg-gray-50 rounded-xl shadow-sm border border-gray-100 text-gray-600 transition-all flex items-center gap-2 font-medium text-sm">
                <Printer size={16} />
                Print Order
              </button>
              <button className="p-3 bg-white hover:bg-gray-50 rounded-xl shadow-sm border border-gray-100 text-gray-600 transition-all flex items-center gap-2 font-medium text-sm">
